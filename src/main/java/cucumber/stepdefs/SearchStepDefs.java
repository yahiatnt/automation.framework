...
public class SearchStepDefs {
	...
	public void verifyNumberOfProductsListed(int expectedCount) {
		Assert.assertTrue(stepData.productName + "is listed",
				stepData.searchResults.isProductListed(stepData.productName));
		Assert.assertEquals("Number of products listed", expectedCount,
				stepData.searchResults.getNumberOfListedProducts());
	}
